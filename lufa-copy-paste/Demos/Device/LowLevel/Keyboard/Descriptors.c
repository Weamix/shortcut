 ...
 *  process begins.
 */
const USB_Descriptor_Device_t PROGMEM
DeviceDescriptor =
        {
                ...
                .PGM_Interface =
                        {
                                ...
                                .InterfaceNumber    = INTERFACE_ID_PGM,
                                .AlternateSetting       = 0x00,
                ...
                .PGM_INEndpoint =
                        {
                                ...
                                .EndpointAddress        = PGM_IN_EPADDR,
                                .Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC |
                                                           ENDPOINT_USAGE_DATA),
                                .EndpointSize           = PGM_INEPSIZE,
                                .PollingIntervalMS      = 0x05
                        },
                ...
                .PGM_OUTEndpoint =
                        {
                                ...
                                .EndpointAddress        = PGM_OUT_EPADDR,
                                .Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC |
                                                           ENDPOINT_USAGE_DATA),
                                .EndpointSize           = PGM_OUTEPSIZE,
                                .PollingIntervalMS      = 0x05
                        }
        };
 ...
 */
const USB_Descriptor_String_t PROGMEM
ProductString = USB_STRING_DESCRIPTOR(L"LUFA Keyboard Demo");
